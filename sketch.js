...
function setup(){
 ...
 bg.velocityY=12;
 bg.scale=1.7
 man=createSprite(windowWidth/2,windowHeight/2+35)
 man.addAnimation("background",manImg)
 man.setCollider("rectangle",0,0,70,200)
// man.debug=true;
 man.scale=1.0
 monster=createSprite(windowWidth/2,windowHeight/2+260)
...
function draw(){
  ...
  textStyle(BOLD)
  fill("blue")
  text("Try your best!",windowWidth/2-180,windowHeight/2+300)
  textSize(30)
  textFont("Helvetica")
  textStyle(BOLD)
  fill("orangered")
  text("The Infinite Forest Run",windowWidth/2-190,windowHeight/2-280)
  textSize(30);
  textFont("Helvetica")
  textStyle(BOLD)
  fill("yellow")
